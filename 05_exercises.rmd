...
small_trains %>% 
  ...
  labs(title = "Delayed trips by year", y = "Average percentage delayed")+
...
ggmap(panama_map) +
  ...
  theme(legend.box.background = element_blank(),
   ...
   #have tried to move this, but after a long time searching online, I could not find any clear solutions. I think the issue is that there are two legends. I am unsure how to change this...
  theme_map() +
...
https://github.com/jenarsso/Exercise-5
